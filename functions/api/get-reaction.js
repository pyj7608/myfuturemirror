...
① Specific identity: a proper name OR a clear description of what it specifically does and for whom
   — A category label (e.g. "web service", "app", "startup") combined only with adjectives (e.g. "innovative", "AI-based") does NOT qualify
   — There must be substance: what it is, what it does, or what problem it solves
② Concrete figure: at least one measurable result (revenue, users, team size, rankings, etc.)
③ Story subject: clear enough to write a story about this specific person's achievement
