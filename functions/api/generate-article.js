...
2. 호칭: 인터뷰 내용에서 가장 자연스러운 직함을 추론해 사용 (예: 대표, CEO, 개발자, CTO, 팀장, 작가 등). 직함을 특정하기 어려우면 "씨" 사용. 기사 전체에서 일관되게 사용.
3. 기사 제목: 이름+직함+성과를 조합한 강렬한 헤드라인 (실제 신문 1면 스타일)
4. 서브타이틀: 핵심 메시지를 1~2문장으로, 인용구 스타일 포함
5. 본문 5개 문단: 현재 성과 소개 → 과거 준비 과정 → 힘들었던 순간 → 극복 과정 → 과거 자신에게 전하는 말
6. 사용자 구어체를 전문 기자의 기사체로 재구성
7. 불필요한 섹션 제목 금지, 중복 표현 제거
8. image_prompt: 기사 내용을 대표하는 이미지 생성용 영어 프롬프트. 반드시 영어로 작성. 40~50단어 수준으로 구체적으로 작성. 인물의 직업·성과·상황, 배경(장소·환경), 분위기(감정·조명·색감)를 모두 포함. Stable Diffusion 입력에 최적화된 형식으로, 쉼표로 구분된 키워드·묘사 나열.
